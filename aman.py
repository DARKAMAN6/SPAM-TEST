...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await idk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await idk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await idk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await idk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await ydk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await ydk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await ydk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await ydk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await wdk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await wdk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await wdk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await wdk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await hdk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await hdk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await hdk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await hdk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await sdk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await sdk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await sdk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await sdk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await adk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await adk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await adk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await adk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await bdk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await bdk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await bdk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await bdk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await cdk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await cdk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await cdk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await cdk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await ddk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await ddk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await ddk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await ddk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await edk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await edk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await edk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await edk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await vkk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await vkk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await vkk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await vkk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await kkk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await kkk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await kkk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await kkk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await lkk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await lkk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await lkk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await lkk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await mkk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await mkk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await mkk(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await mkk(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await sid(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await sid(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await sid(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await sid(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await shy(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await shy(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await shy(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await shy(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await aan(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await aan(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await aan(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await aan(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await ake(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await ake(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await ake(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await ake(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await eel(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await eel(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await eel(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await eel(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await khu(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await khu(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await khu(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await khu(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await shi(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await shi(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await shi(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await shi(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await yaa(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await yaa(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await yaa(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await yaa(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await dav(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await dav(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await dav(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await dav(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await raj(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await raj(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await raj(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await raj(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await put(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await put(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await put(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await put(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tsix:
        ...
        try:
            ...
            await eag(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await eag(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await eag(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await eag(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await eag(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tseven:
        ...
        try:
            ...
            await gle.start()
            await gle(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await gle(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await gle(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await gle(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await gle(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
    ...
    if teight:
        ...
        try:
            ...
            await wal.start()
            await wal(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await wal(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await wal(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await wal(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
    ...
    if tnine:
        ...
        try:
            ...
            await aaa.start()
            await aaa(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await aaa(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await aaa(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await aaa(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await aaa(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
    ...
    if thirty:
        ...
        try:
            ...
            await boy.start()
            await boy(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await boy(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await boy(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
            await boy(functions.channels.JoinChannelRequest(channel="@YUKKI_X_UPDATES"))
            await boy(functions.channels.JoinChannelRequest(channel="@SAB_KAA_KATEGA"))
